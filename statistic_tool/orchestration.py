...
KLD_title = ['type', 'srcIP', 'dstIP', 'sport', 'dport', 'proto', 'pktLen']
KLD_filename = 'All_KLD.csv'
error_title = ['type', 'srcIP', 'dstIP', 'sport', 'dport', 'proto', 'pktLen']
